...
nginx::resource::vhost { 'github.dev':
  ensure      => present,
  server_name => [
    'github.dev',
    'www.github.dev',
...
nginx::resource::location { 'github.dev-php':
  ensure              => 'present',
  index_files         => [
    'app_dev.php',
    'app.php',
...
nginx::resource::vhost { 'xhprof.github.dev':
  ensure       => present,
  server_name  => ['xhprof.github.dev'],
...
nginx::resource::location { 'xhprof.github.dev-php':
  ensure              => 'present',
  index_files         => ['index.php', 'index.html'],
  vhost               => 'xhprof.github.dev',
  location            => '~ \.php$',
  proxy               => undef,
  try_files           => ['$uri', '$uri/', '/index.php?$args'],
  www_root            => '/var/www/vendor/facebook/xhprof/xhprof_html/',
